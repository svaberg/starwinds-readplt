...
def test_read_variables():
    ...
    ds = Dataset.from_dat("sample_data/x=0_var_2_n00000000.dat")
...
def sample_files(folder="sample_data"):
...
def test_data_equal():
    ...
    ds_dat = Dataset.from_file("sample_data/x=0_var_2_n00000000.dat")
    ds_plt = Dataset.from_file("sample_data/x=0_var_2_n00000000.plt")
